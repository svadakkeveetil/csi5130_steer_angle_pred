...
bridge = CvBridge()
global count
#t_start = 1479424215880
#t_start = 1479424439139
#t_start = 
#t_start = 1479425729831
#t_start = 1479425834048
t_start = 1479426202229
count = 0
def extract_steering_angle(msg):
    ...
    if t_temp > t_start and count<=50000:
...
def image_callback(msg):
    ...
    try:
        ...
        file_name = '/home/dhavan/AI_Project/Data/HMB_6/' + str(image_time_stamp) + '.jpg'
        cv2.imwrite(file_name, cv_image)
        rospy.loginfo(f"Image saved as {file_name}")
    except Exception as e:
        rospy.logerr(f"Error converting image: {e}")
# Subscribe to the image topic
csvfile = open('train_round2_part5' + '.csv', 'w', newline='')
